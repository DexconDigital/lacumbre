...
<div class="fixed-top total-menu">
    <div class="bg-light bg-transparent d-none d-lg-block" id="menu_contacto">
        <div class="container d-flex justify-content-lg-around information ">
            <div>
            ...
            <div>
                <small><a href="tel:<?php echo $datos_contacto['celular']['link'] ?>"><i class="fas fa-mobile-alt m-2"></i><?php echo $datos_contacto['celular']['imprimir'] ?></a></small>
                <small><a href="tel:<?php echo $datos_contacto['telefono_fijo']['link'] ?>"><i class="fas fa-phone-alt m-2 colo_insta"></i><?php echo $datos_contacto['telefono_fijo']['imprimir'] ?></a></small>
                <small><a target="_blank" href="<?php echo $datos_contacto['whatsapp']['link'] ?>"><i class="fab fa-whatsapp m-2 color_twi"></i><?php echo $datos_contacto['whatsapp']['imprimir'] ?></a></small>
            </div>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id='menu'>
        <div class="container">
            <a class="navbar-brand" href="./">
                <img src="images/Logo_Blanco.png" width="auto" height="70" alt="" id="imagen_menu">
            </a>
